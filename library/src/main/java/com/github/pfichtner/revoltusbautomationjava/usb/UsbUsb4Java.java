...
public class UsbUsb4Java implements Usb, Closeable {
	...
	private UsbUsb4Java(short vendorId, short productId) {
		checkRc(LibUsb.init(this.context), "Unable to initialize libusb");
		this.vendorId = vendorId;
		this.productId = productId;
	}

	public static UsbUsb4Java newInstance(short vendorId, short productId) {
